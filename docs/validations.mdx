...
<Canvas name="string validation" of={ValidationsStories.StringValidation} />

Passing a `boolean` to these props will display a border and validation icon without the additional tooltip information.

<Canvas name="boolean validation" of={ValidationsStories.BooleanValidation} />
...
<Canvas
  ...
  of={ValidationsStories.DateRangeValidation}
/>
...
<Canvas
  name="grouped input validation"
  of={ValidationsStories.GroupedInputValidation}
/>
...
<Canvas
  name="grouped legend validation"
  of={ValidationsStories.GroupedLegendValidation}
/>
...
<Canvas name="grouped required" of={ValidationsStories.GroupedRequired} />
