...
<Canvas name="default" of={TileStories.DefaultStory} />

### With large roundness on corners

<Canvas name="large roundness" of={TileStories.LargeRoundness} />

### Vertical

The Tile component can be also have a vertical layout.

<Canvas name="vertical" of={TileStories.Vertical} />

### With TileFooter

<Canvas name="with TileFooter" of={TileStories.WithTileFooter} />
...
<Canvas name="custom Widths" of={TileStories.CustomWidths} />
...
<Canvas name="custom heights" of={TileStories.CustomHeights} />

### Active Tile

<Canvas name="active" of={TileStories.Active} />
...
<Canvas name="custom borders" of={TileStories.CustomBorders} />

### With inline styling

The Tile component can also have inline styling applied to the content.

<Canvas name="with Inline" of={TileStories.WithInline} />

### With different padding and margin

<Canvas
  name="with different padding and margin"
  of={TileStories.WithDifferentPaddingAndMargin}
/>
...
<Canvas
  ...
  of={TileStories.WithDefinitionListDefault}
/>
...
<Canvas
  ...
  of={TileStories.WithDefinitionListAndCustomWidth}
/>
...
<Canvas
  ...
  of={TileStories.WithDefinitionListAndCustomTextAlignment}
/>
...
<Canvas
  ...
  of={TileStories.WithDefinitionListAndActionPopoverAndIconSupport}
/>

### With Accordion and Definition List

<Canvas name="with Accordion" of={TileStories.WithAccordion} />

### With Accordion and TileFooter

<Canvas
  name="with Accordion and TileFooter"
  of={TileStories.WithAccordionAndTileFooter}
/>
...
<Canvas name="Responsive Tile" of={TileStories.ResponsiveDefaultStory} />

### Responsive Tile with custom gaps

<Canvas name="Responsive Tile with custom gaps" of={TileStories.CustomGaps} />
...
<Canvas
  ...
  of={TileStories.FixedContainers}
/>
...
<Canvas
  ...
  of={TileStories.ProportionateWidths}
/>
...
<Canvas name="Responsive Tile with align content" of={TileStories.Align} />
