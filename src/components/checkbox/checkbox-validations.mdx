...
<Canvas
  ...
  story={stories.NewInline}
/>

<Canvas
  name="New Valdations - string inline"
  story={stories.NewStringValidationInline}
/>
...
<Canvas
  name="single checkbox - string validation"
...
<Canvas
  name="single checkbox - boolean validation"
...
<Canvas
  name="group checkbox - string validation"
...
<Canvas
  name="group checkbox - boolean validation"
