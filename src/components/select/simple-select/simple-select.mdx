...
<Meta title="Select" parameters={{ info: { disable: true } }} of={SimpleSelectStories} />
...
<Canvas name="default" of={SimpleSelectStories.Default} />

### Required

You can use the `required` prop to indicate if the field is mandatory.

<Canvas name="required" of={SimpleSelectStories.Required} />

### List placement

You can use `listPlacement` prop to set the position of the select list relative to the input element.

<Canvas name="list placement" of={SimpleSelectStories.ListPlacement} />

### List height

You can use `listMaxHeight` prop to override default max height value of select list.

<Canvas name="list height" of={SimpleSelectStories.ListHeight} />

### Controlled usage

<Canvas name="controlled" of={SimpleSelectStories.Controlled} />
...
<Canvas name="with object as value" of={SimpleSelectStories.WithObjectAsValue} />

### With custom maxWidth

In this example the `maxWidth` prop is 100%.

<Canvas name="With custom maxWidth" of={SimpleSelectStories.WithCustomMaxWidth} />
...
<Canvas name="with isLoading prop" of={SimpleSelectStories.WithIsLoadingProp} />
...
<Canvas name="with infinite scroll" of={SimpleSelectStories.WithInfiniteScroll} />

### Open on focus

<Canvas name="openOnFocus" of={SimpleSelectStories.OpenOnFocus} />

### Disabled

<Canvas name="disabled" of={SimpleSelectStories.Disabled} />

### Read Only

<Canvas name="readonly" of={SimpleSelectStories.Readonly} />

### Transparent

<Canvas name="transparent" of={SimpleSelectStories.Transparent} />

### With disabled portal

<Canvas name="withDisabledPortal" of={SimpleSelectStories.WithDisabledPortal} />

### Custom Option content

<Canvas name="custom option children" of={SimpleSelectStories.CustomOptionChildren} />

### With multiple columns

<Canvas name="with multiple columns" of={SimpleSelectStories.WithMultipleColumns} />

### Option groups

<Canvas name="option groups" of={SimpleSelectStories.OptionGroups} />
...
<Canvas name="enabling adaptive behaviour" of={SimpleSelectStories.EnablingAdaptiveBehaviour} />

#### New designs validation

<Canvas name="validations - string - new design" of={SimpleSelectStories.ValidationsStringNewDesign} />
...
<Canvas name="virtualised" of={SimpleSelectStories.Virtualised} />

### With multiple columns and virtualisation

<Canvas name="with multiple columns and virtualisation" of={SimpleSelectStories.WithMultipleColumnsAndVirtualisation} />
...
<Canvas name="selection confirmed" of={SimpleSelectStories.SelectionConfirmedStory} />
...
<Canvas name="dynamically adding options" of={SimpleSelectStories.SelectWithDynamicallyAddedOption} />
