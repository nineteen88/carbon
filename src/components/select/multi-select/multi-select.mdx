...
<Canvas name="default" of={MultiSelectStories.Default} />

### List placement

You can use `listPlacement` prop to set the position of the select list relative to the input element.

<Canvas name="list placement" of={MultiSelectStories.ListPlacement} />

### List height

You can use `listMaxHeight` prop to override default max height value of select list.

<Canvas name="list height" of={MultiSelectStories.ListHeight} />

### Controlled Usage

<Canvas name="controlled" of={MultiSelectStories.Controlled} />

### Open on focus

<Canvas name="openOnFocus" of={MultiSelectStories.OpenOnFocus} />

### Disabled

<Canvas name="disabled" of={MultiSelectStories.Disabled} />

### Read Only

<Canvas name="readonly" of={MultiSelectStories.Readonly} />

### With disabled portal

<Canvas name="withDisabledPortal" of={MultiSelectStories.WithDisabledPortal} />

### With multiple columns:

<Canvas
  name="with multiple columns"
  of={MultiSelectStories.WithMultipleColumns}
/>
...
<Canvas name="required" of={MultiSelectStories.Required} />
...
<Canvas name="with object as value" of={MultiSelectStories.WithObjectAsValue} />
...
<Canvas name="with isLoading prop" of={MultiSelectStories.WithIsLoadingProp} />
...
<Canvas
  name="with custom colored pills"
  of={MultiSelectStories.WithCustomColoredPills}
/>
...
<Canvas
  ...
  of={MultiSelectStories.WithCustomMaxWidth}
/>
...
<Canvas
  ...
  of={MultiSelectStories.ValidationsStringNewDesign}
/>
...
<Canvas name="pills with long text" of={MultiSelectStories.PillsWithLongText} />
...
<Canvas name="virtualised" of={MultiSelectStories.Virtualised} />
