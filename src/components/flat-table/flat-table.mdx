...
<Canvas name="default" of={FlatTableStories.DefaultStory} />
...
<Canvas name="with row header" of={FlatTableStories.WithRowHeader} />
...
<Canvas
  name="with multiple row headers"
  of={FlatTableStories.WithMultipleRowHeaders}
/>
...
<Canvas
  ...
  of={FlatTableStories.HorizontalScrolling}
/>
...
<Canvas
  name="with custom cell paddings"
  of={FlatTableStories.WithCustomCellPaddings}
/>
...
<Canvas
  name="with custom column width"
  of={FlatTableStories.WithCustomColumnWidth}
/>
...
<Canvas
  name="with custom row background color"
  of={FlatTableStories.WithCustomRowBackgroundColor}
/>

### With custom horizontal border size

<Canvas
  name="with custom horizontal border size"
  of={FlatTableStories.WithCustomHorizontalBorderSize}
/>

### With custom horizontal border color

<Canvas
  name="with custom horizontal border color"
  of={FlatTableStories.WithCustomHorizontalBorderColor}
/>

### With custom vertical borders

<Canvas
  name="with custom vertical borders"
  of={FlatTableStories.WithCustomVerticalBorders}
/>

### With alternative header background

<Canvas
  name="with alternative header background"
  of={FlatTableStories.WithAlternativeHeaderBackground}
/>
...
<Canvas
  name="with truncated cell content"
  of={FlatTableStories.WithTruncatedCellContent}
/>
...
<Canvas name="with sticky head" of={FlatTableStories.WithStickyHead} />
...
<Canvas
  name="with stickyHead rowspan and colspan"
  of={FlatTableStories.WithStickyHeadRowSpanAndColspan}
/>

### With stickyFooter prop set to true

<Canvas name="with sticky footer" of={FlatTableStories.WithStickyFooter} />
...
<Canvas
  ...
  of={FlatTableStories.WithStickyFooterInsideOfLargerDiv}
/>
...
<Canvas name="with hasMaxHeight" of={FlatTableStories.WithHasMaxHeight} />

### With clickable rows

<Canvas name="with clickable rows" of={FlatTableStories.WithClickableRows} />

### With zebra stripes

<Canvas name="zebra" of={FlatTableStories.Zebra} />

### With sorting headers

<Canvas name="with sorting headers" of={FlatTableStories.WithSortingHeaders} />

### With a cell spanning the whole row

<Canvas name="with colspan" of={FlatTableStories.WithColspan} />

### With a cell spanning the whole column

<Canvas name="with rowspan" of={FlatTableStories.WithRowspan} />
...
<Canvas name="selectable rows" of={FlatTableStories.WithSelectableRows} />
...
<Canvas name="highlightable rows" of={FlatTableStories.WithHighlightableRows} />
...
<Canvas
  ...
  of={FlatTableStories.WithSelectableAndHighlightableRows}
/>
...
<Canvas name="paginated" of={FlatTableStories.Paginated} />
...
<Canvas
  ...
  of={FlatTableStories.PaginatedWithStickyHeader}
/>
...
<Canvas
  ...
  of={FlatTableStories.WhenAChildOfSidebar}
/>

## Table Cell Sizes

<Canvas name="sizes" of={FlatTableStories.Sizes} />

## Draggable rows

<Canvas name="with draggable rows" of={FlatTableStories.WithDraggableRows} />
...
<Canvas name="wrapping row headers" of={FlatTableStories.WrappingRowHeaders} />
