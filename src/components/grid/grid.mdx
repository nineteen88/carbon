...
<Meta
  title="Grid"
  parameters={{ chromatic: { disableSnapshot: true }, info: { disable: true } }}
  of={GridStories}
/>
...
<Canvas
  ...
  of={GridStories.ResponsiveSettings}
/>
