...
<Canvas name="default" of={FileInputStories.Default} />

### With inputHint

<Canvas name="with inputHint" of={FileInputStories.WithInputHint} />

### Required

You can use the `required` prop to indicate if the field is mandatory.

<Canvas name="required" of={FileInputStories.Required} />
...
<Canvas name="increased height" of={FileInputStories.IncreasedHeight} />

#### Both height and width increased

<Canvas name="increased width and height" of={FileInputStories.IncreasedBoth} />
...
<Canvas name="100% width" of={FileInputStories.FullWidth} />
...
<Canvas
  name="increased width - responsive"
  of={FileInputStories.IncreasedWidthResponsive}
/>
...
<Canvas name="vertical" of={FileInputStories.Vertical} />
...
<Canvas name="validations" of={FileInputStories.Validation} />
...
<Canvas name="accept" of={FileInputStories.Accept} />
...
<Canvas name="validation example" of={FileInputStories.FileTypeValidation} />
...
<Canvas
  name="tracking upload status on client side"
  of={FileInputStories.UploadStatusClient}
/>
...
<Canvas
  name="tracking upload status alternative"
  of={FileInputStories.UploadStatusAlternative}
/>
...
<Canvas
  name="with loader animation"
  of={FileInputStories.UploadStatusNoProgress}
/>
